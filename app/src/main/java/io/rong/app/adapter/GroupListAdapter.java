...
public class GroupListAdapter extends BaseAdapter  {
    ...
    public GroupListAdapter(Context context, List<ClassGroup> result, HashMap<String, Group> group) {
    ...
    @Override
    public ClassGroup getItem(int position) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (viewHolder != null) {
            ...
            viewHolder.mGroupName.setText(mResults.get(position).getClassName());
            viewHolder.mGroupCurrentNum.setText(mResults.get(position).getNumber() + "/");
            viewHolder.mGroupCurrentSum.setText(mResults.get(position).getMaxNumber());
