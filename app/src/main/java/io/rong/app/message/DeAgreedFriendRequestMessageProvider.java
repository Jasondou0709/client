 ...
 */
@ProviderTag(messageContent = TextMessage.class, showPortrait = false, centerInHorizontal = false,showProgress = false,hide = true)
public class DeAgreedFriendRequestMessageProvider extends IContainerItemProvider.MessageProvider<DeAgreedFriendRequestMessage> {
    ...
    @Override
    public void onItemLongClick(View view, int position, DeAgreedFriendRequestMessage content, final UIMessage message) {
        String name = null;
